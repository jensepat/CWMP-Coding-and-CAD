...
#####################################
# NEPTUNIUM CERMET TARGET (NpO2-Al) #
#####################################
# Based on Generation II HFIR Cermet Design
npo2 = openmc.Material()
npo2.name = 'Neptunium Cermet Pellet'
npo2.id = 93001

# Mass fractions for a ~20 vol% NpO2 in Aluminum matrix
npo2.add_nuclide('Np237', 0.4466, 'wo')
npo2.add_element('O',     0.0603, 'wo')
npo2.add_element('Al',    0.4931, 'wo')

npo2.set_density('g/cm3', 4.38)
cmap[npo2] = (100, 50, 150)

npo2.depletable = True
