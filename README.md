...
This repository contains OpenMC computational models for the Oregon State TRIGA Reactor (OSTR) with three different target configurations. All models are developed in Python using the OpenMC nuclear transport simulation code.

## Repository Structure

The repository is organized into three main model directories:
